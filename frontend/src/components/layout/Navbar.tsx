...
export default function Navbar({ centerLabel }: NavbarProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between h-[60px] px-6 border-b transition-colors" style={{ backgroundColor: `rgb(var(--color-surface))`, color: `rgb(var(--text-color))`, borderColor: `rgba(var(--text-color), 0.1)` }}>
      {/* Logo */}
